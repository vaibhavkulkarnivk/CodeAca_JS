...
function createEmployee(firstname,lastname){
    ...
    console.log('now this object is ::'+this);//here this is global object => window
    return emp;
}
//Calling
...
function createEmployeeTHIS(firstname,lastname){ //to give hint to other programmer that this is constructor is first letter capital
    ...
    console.log('now this object is ::'+this); //here this is empty object created by JS
...
obj.foo = function(){
    ...
    console.log('now this object is ::'+this); //here this refers to object which is calling function
}
