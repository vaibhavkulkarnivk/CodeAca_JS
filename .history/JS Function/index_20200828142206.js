...
abc('pqr');
*/
//----------Function in JS can be of two types :: declaration and function expression diff 
/*
...
//IMP NOTE : Function expression is function declaration which assinged to variable not this not a call and return type is assigned
/*
var f = function(){
...
function CreateEmployeeTHIS(firstname,lastname){ //to give hint to other programmer that this is constructor function so first letter capital
    //var this = {}; //JS internally does -- 
    this.FirstName = firstname;
    this.LastName = lastname;
    console.log(this); //here this is empty object created by JS
    //return this;//JS internally does -- ;
}
//calling
var emp = new CreateEmployeeTHIS('Jitu','Patil'); //differentiate between constructor and normal function, with first letter as capital
console.log(emp);
console.log('FIRST NAME::'+emp.FirstName);
console.log('FIRST NAME::'+emp.LastName);
*/
...
//here we are calling function exmpression from another object i.e. calling function of employee using another function object of AssociateHR
...
//Dynamic addition using implicite arguments from JS
/*
//as we are using implicite arguments so need of params here 
var add = function(){ 
    var i,sum=0;
...
var gotData = function(data, fn, data2){
    console.log('First level:'+data);
    //call another function from this funtion
    fn(data2);
}
var gotDataData = function(data2){
